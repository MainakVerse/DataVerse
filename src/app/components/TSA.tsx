...
export default function TSA() {
  const features = [
    {
      title: "Trend",
      description: "Start by identifying the general direction or movement in the data over time.",
      icon: <FaArrowTrendUp className="w-8 h-8" />,
    },
    {
      title: "Seasonality", 
      description: "Next, learn to recognize repeating patterns or cycles at fixed intervals.",
      icon: <FaThinkPeaks className="w-8 h-8" />,
    },
    {
      title: "Autocorrelation ",
      description: "Then, study how current data points relate to past values to understand dependencies.",
      icon: <SlGraph className="w-8 h-8" />,
    },
    {
      title: "Stationarity",
      description: "Finally, grasp stationarity, ensuring statistical properties remain constant, which is key for many models.",
      icon: <BsPersonStanding className="w-8 h-8" />,
    },
